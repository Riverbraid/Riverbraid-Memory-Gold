...
Riverbraid-Memory-Gold is a canonical Gold module surface within Riverbraid.

This repository represents the Memory domain inside the current Evaluation Kit registry. It supports deterministic memory signal filtering and persistence review material as part of the public Riverbraid verification constellation while Riverbraid-Core remains the normative source for protocol semantics.
